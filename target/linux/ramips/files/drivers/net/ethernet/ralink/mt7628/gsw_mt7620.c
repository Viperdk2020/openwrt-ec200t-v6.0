...
static void mt7628_apply_dts_power_mask(struct mt7620_gsw *gsw)
{
	int i;
	u32 val;
...
static const struct of_device_id mediatek_gsw_match[] = {
	...
	{ .compatible = "mediatek,mt7628-gsw" },
	{},
};
...
int mtk_gsw_init(struct fe_priv *priv)
{
	...
	/* Apply DTS-driven PHY power mask */
	mt7628_apply_dts_power_mask(gsw);
